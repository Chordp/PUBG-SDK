...
#include "PUBG_ReviveToZombieParticle_structs.hpp"
...
// BlueprintGeneratedClass ReviveToZombieParticle.ReviveToZombieParticle_C
// 0x0000 (0x04C0 - 0x04C0)
class AReviveToZombieParticle_C : public ATslParticle
{
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr;
		if(!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass ReviveToZombieParticle.ReviveToZombieParticle_C"));
