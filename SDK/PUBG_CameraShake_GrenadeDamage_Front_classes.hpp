...
#include "PUBG_CameraShake_GrenadeDamage_Front_structs.hpp"
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr;
		if(!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass CameraShake_GrenadeDamage_Front.CameraShake_GrenadeDamage_Front_C"));
