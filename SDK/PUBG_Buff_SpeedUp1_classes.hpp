...
#include "PUBG_Buff_SpeedUp1_structs.hpp"
...
class ABuff_SpeedUp1_C : public ATslBuff
{
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr;
		if(!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass Buff_SpeedUp1.Buff_SpeedUp1_C"));
	...
	void ExecuteUbergraph_Buff_SpeedUp1(int EntryPoint);
};
