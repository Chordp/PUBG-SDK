...
#include "PUBG_P_Footprint_Lava_BP_structs.hpp"
...
class AP_Footprint_Lava_BP_C : public ATslParticle
{
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr;
		if(!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass P_Footprint_Lava_BP.P_Footprint_Lava_BP_C"));
