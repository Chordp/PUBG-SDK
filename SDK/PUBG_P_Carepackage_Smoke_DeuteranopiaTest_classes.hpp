...
#include "PUBG_P_Carepackage_Smoke_DeuteranopiaTest_structs.hpp"
...
class AP_Carepackage_Smoke_DeuteranopiaTest_C : public ATslParticle
{
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr;
		if(!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass P_Carepackage_Smoke_DeuteranopiaTest.P_Carepackage_Smoke_DeuteranopiaTest_C"));
