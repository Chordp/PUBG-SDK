...
void AWaterDecal03_C::SetDecalMaterial(class UMaterialInterface* NewDecalMaterial)
{
	static UFunction* fn;
...
class UMaterialInterface* AWaterDecal03_C::GetDecalMaterial()
{
	static UFunction* fn;
...
class UMaterialInstanceDynamic* AWaterDecal03_C::CreateDynamicMaterialInstance()
{
	static UFunction* fn;
