...
#include "PUBG_BP_Console_Icon_Option_classes.hpp"
...
struct UBP_Console_Icon_Option_C_PreConstruct_Params
{
	bool                                               IsDesignTime;                                             // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function BP_Console_Icon_Option.BP_Console_Icon_Option_C.Construct
struct UBP_Console_Icon_Option_C_Construct_Params
{
};

// Function BP_Console_Icon_Option.BP_Console_Icon_Option_C.ExecuteUbergraph_BP_Console_Icon_Option
struct UBP_Console_Icon_Option_C_ExecuteUbergraph_BP_Console_Icon_Option_Params
{
