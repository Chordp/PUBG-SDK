...
public:
	...
	struct FColor                                      InputColor;                                               // 0x0060(0x0004) (Edit, Config, IsPlainOldData)
	struct FColor                                      HistoryColor;                                             // 0x0064(0x0004) (Edit, Config, IsPlainOldData)
	struct FColor                                      AutoCompleteCommandColor;                                 // 0x0068(0x0004) (Edit, Config, IsPlainOldData)
	struct FColor                                      AutoCompleteCVarColor;                                    // 0x006C(0x0004) (Edit, Config, IsPlainOldData)
	struct FColor                                      AutoCompleteFadedColor;                                   // 0x0070(0x0004) (Edit, Config, IsPlainOldData)
...
{
public:
	struct FStringAssetReference                       EditorStartupMap;                                         // 0x0030(0x0010) (Edit, Config)
	struct FString                                     LocalMapOptions;                                          // 0x0040(0x0010) (Edit, ZeroConstructor, Config)
	struct FStringAssetReference                       TransitionMap;                                            // 0x0050(0x0010) (Edit, Config)
	bool                                               bUseSplitscreen;                                          // 0x0060(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
	TEnumAsByte<ETwoPlayerSplitScreenType>             TwoPlayerSplitscreenLayout;                               // 0x0061(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
	TEnumAsByte<EThreePlayerSplitScreenType>           ThreePlayerSplitscreenLayout;                             // 0x0062(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
	bool                                               bOffsetPlayerGamepadIds;                                  // 0x0063(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x0064(0x0004) MISSED OFFSET
	struct FStringClassReference                       GameInstanceClass;                                        // 0x0068(0x0010) (Edit, Config, NoClear)
	struct FStringAssetReference                       GameDefaultMap;                                           // 0x0078(0x0010) (Edit, Config)
	struct FStringAssetReference                       ServerDefaultMap;                                         // 0x0088(0x0010) (Edit, Config)
	struct FStringClassReference                       GlobalDefaultGameMode;                                    // 0x0098(0x0010) (Edit, Config, NoClear)
	struct FStringClassReference                       GlobalDefaultServerGameMode;                              // 0x00A8(0x0010) (Edit, Config)
	TArray<struct FGameModeName>                       GameModeMapPrefixes;                                      // 0x00B8(0x0010) (Edit, ZeroConstructor, Config)
	TArray<struct FGameModeName>                       GameModeClassAliases;                                     // 0x00C8(0x0010) (Edit, ZeroConstructor, Config)
...
public:
	...
	struct FGuid                                       ProjectID;                                                // 0x00A0(0x0010) (Edit, Config, IsPlainOldData)
	...
	bool                                               bAllowWindowResize;                                       // 0x0113(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
	bool                                               bAllowClose;                                              // 0x0114(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
	bool                                               bAllowMaximize;                                           // 0x0115(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
	bool                                               bAllowMinimize;                                           // 0x0116(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
