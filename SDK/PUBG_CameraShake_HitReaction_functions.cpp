...
#include "PUBG_CameraShake_HitReaction_parameters.hpp"
...
void UCameraShake_HitReaction_C::ReceiveStopShake(bool bImmediately)
{
	static UFunction* fn;
	...
	UCameraShake_HitReaction_C_ReceiveStopShake_Params params;
...
void UCameraShake_HitReaction_C::ReceivePlayShake(float Scale)
{
	static UFunction* fn;
	...
	UCameraShake_HitReaction_C_ReceivePlayShake_Params params;
	params.Scale = Scale;
...
bool UCameraShake_HitReaction_C::ReceiveIsFinished()
{
	static UFunction* fn;
	...
	UCameraShake_HitReaction_C_ReceiveIsFinished_Params params;
...
void UCameraShake_HitReaction_C::BlueprintUpdateCameraShake(float DeltaTime, float ALPHA, const struct FMinimalViewInfo& POV, struct FMinimalViewInfo* ModifiedPOV)
{
	static UFunction* fn;
	...
	UCameraShake_HitReaction_C_BlueprintUpdateCameraShake_Params params;
