...
public:
	...
	class UMasterySkinnableProp*                       VehicleMesh;                                              // 0x0458(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class UMasterySkinnablePropStatic*                 HelmMesh;                                                 // 0x0460(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	class USpotLightComponent*                         SpotLight2;                                               // 0x0478(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
