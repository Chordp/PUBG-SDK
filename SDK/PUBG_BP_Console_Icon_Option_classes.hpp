...
#include "PUBG_BP_Console_Icon_Option_structs.hpp"
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr;
		if(!ptr)
			ptr = UObject::FindClass(_xor_("WidgetBlueprintGeneratedClass BP_Console_Icon_Option.BP_Console_Icon_Option_C"));
