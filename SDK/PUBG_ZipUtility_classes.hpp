...
public:
	...
	bool STATIC_UnzipFiles(TArray<int>* fileIndices, struct FString* ArchivePath, class UObject** ZipUtilityInterfaceDelegate, TEnumAsByte<EZipUtilityCompressionFormat>* Format);
	bool STATIC_UnzipFileNamedTo(struct FString* ArchivePath, struct FString* Name, struct FString* destinationPath, class UObject** ZipUtilityInterfaceDelegate, TEnumAsByte<EZipUtilityCompressionFormat>* Format);
