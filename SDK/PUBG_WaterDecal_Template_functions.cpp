...
#include "PUBG_WaterDecal_Template_parameters.hpp"
...
void AWaterDecal_Template_C::STATIC_SetDecalMaterial(class UMaterialInterface* NewDecalMaterial)
{
	static UFunction* fn;
	...
	AWaterDecal_Template_C_SetDecalMaterial_Params params;
...
class UMaterialInterface* AWaterDecal_Template_C::STATIC_GetDecalMaterial()
{
	static UFunction* fn;
	...
	AWaterDecal_Template_C_GetDecalMaterial_Params params;
...
class UMaterialInstanceDynamic* AWaterDecal_Template_C::STATIC_CreateDynamicMaterialInstance()
{
	static UFunction* fn;
	...
	AWaterDecal_Template_C_CreateDynamicMaterialInstance_Params params;
