...
void AWaterDecal_Template_C::SetDecalMaterial(class UMaterialInterface* NewDecalMaterial)
{
	static UFunction* fn;
...
class UMaterialInterface* AWaterDecal_Template_C::GetDecalMaterial()
{
	static UFunction* fn;
...
class UMaterialInstanceDynamic* AWaterDecal_Template_C::CreateDynamicMaterialInstance()
{
	static UFunction* fn;
