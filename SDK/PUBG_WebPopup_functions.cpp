...
void UWebPopup_C::SetPopupData(const struct FString& PopupId, const struct FString& Uri, bool UseBackgroundColor, const struct FLinearColor& BackgroundColor, bool bShowButtonGroup)
{
	static UFunction* fn;
...
void UWebPopup_C::BndEvt__WebView_K2Node_ComponentBoundEvent_18_UIGTFinishLoadSignature__DelegateSignature(const struct FString& path, bool isMainFrame)
{
	static UFunction* fn;
...
void UWebPopup_C::BndEvt__WebView_K2Node_ComponentBoundEvent_49_UIGTStartLoadingSignature__DelegateSignature(const struct FString& path, bool isMainFrame)
{
	static UFunction* fn;
...
void UWebPopup_C::BndEvt__WebView_K2Node_ComponentBoundEvent_67_UIGTFailLoadSignature__DelegateSignature(const struct FString& path, const struct FString& Error, bool isMainFrame)
{
	static UFunction* fn;
