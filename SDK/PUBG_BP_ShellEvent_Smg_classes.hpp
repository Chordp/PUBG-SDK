...
#include "PUBG_BP_ShellEvent_Smg_structs.hpp"
...
class UBP_ShellEvent_SMG_C : public UTslParticleModuleEventSendToGame
{
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr;
		if(!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_ShellEvent_Smg.BP_ShellEvent_SMG_C"));
	...
	void ExecuteUbergraph_BP_ShellEvent_SMG(int EntryPoint);
};
