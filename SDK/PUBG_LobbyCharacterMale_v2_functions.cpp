...
void ALobbyCharacterMale_v2_C::RemoveCustomAnimation()
{
	static UFunction* fn;
...
ERankType ALobbyCharacterMale_v2_C::GetRankType()
{
	static UFunction* fn;
...
int ALobbyCharacterMale_v2_C::GetRankDivision()
{
	static UFunction* fn;
	...
	ALobbyCharacterMale_v2_C_GetRankDivision_Params params;
...
struct FString ALobbyCharacterMale_v2_C::GetClanName()
{
	static UFunction* fn;
...
EOutGamePlatformProvider ALobbyCharacterMale_v2_C::GetCharacterPlatform()
{
	static UFunction* fn;
...
void ALobbyCharacterMale_v2_C::ApplyCustomAnimation(class UAnimationAsset* Animation)
{
	static UFunction* fn;
