...
#include "PUBG_BP_ShellEvent_DMR_structs.hpp"
...
class UBP_ShellEvent_DMR_C : public UTslParticleModuleEventSendToGame
{
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr;
		if(!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_ShellEvent_DMR.BP_ShellEvent_DMR_C"));
	...
	void ExecuteUbergraph_BP_ShellEvent_DMR(int* EntryPoint);
};
