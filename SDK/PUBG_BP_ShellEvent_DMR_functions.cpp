...
#include "PUBG_BP_ShellEvent_DMR_parameters.hpp"
...
void UBP_ShellEvent_DMR_C::RunEvent(struct FVector* InCollideDirection, struct FVector* InHitLocation, struct FVector* InHitNormal, struct FName* InBoneName, class UWorld** InWorld, class AActor** InActor)
{
	static UFunction* fn;
		...
		if(!fn)
		fn = UObject::FindObject<UFunction>(_xor_("Function BP_ShellEvent_DMR.BP_ShellEvent_DMR_C.RunEvent"));

	UBP_ShellEvent_DMR_C_RunEvent_Params params;
...
void UBP_ShellEvent_DMR_C::ExecuteUbergraph_BP_ShellEvent_DMR(int* EntryPoint)
{
	static UFunction* fn;
		...
		if(!fn)
		fn = UObject::FindObject<UFunction>(_xor_("Function BP_ShellEvent_DMR.BP_ShellEvent_DMR_C.ExecuteUbergraph_BP_ShellEvent_DMR"));

	UBP_ShellEvent_DMR_C_ExecuteUbergraph_BP_ShellEvent_DMR_Params params;
