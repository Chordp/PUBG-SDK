...
public:
	...
	TArray<class UObject*>                             AdditionalEventReceivers;                                 // 0x0730(0x0010) (ZeroConstructor, Transient)
	unsigned char                                      UnknownData01[0x50];                                      // 0x0740(0x0050) MISSED OFFSET
...
{
public:
	bool                                               bUseBurnIn;                                               // 0x0040(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x7];                                       // 0x0041(0x0007) MISSED OFFSET
	struct FStringClassReference                       BurnInClass;                                              // 0x0048(0x0010) (Edit)
	class ULevelSequenceBurnInInitSettings*            Settings;                                                 // 0x0058(0x0008) (Edit, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
...
{
public:
	struct FLevelSequencePlayerSnapshot                FrameInformation;                                         // 0x0260(0x0050) (BlueprintVisible, BlueprintReadOnly)
	class ALevelSequenceActor*                         LevelSequenceActor;                                       // 0x02B0(0x0008) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
