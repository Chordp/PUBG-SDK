...
#include "PUBG_CS_Land_Heavy_parameters.hpp"
...
void UCS_Land_Heavy_C::ReceiveStopShake(bool bImmediately)
{
	static UFunction* fn;
	...
	UCS_Land_Heavy_C_ReceiveStopShake_Params params;
...
void UCS_Land_Heavy_C::ReceivePlayShake(float Scale)
{
	static UFunction* fn;
	...
	UCS_Land_Heavy_C_ReceivePlayShake_Params params;
	params.Scale = Scale;
...
bool UCS_Land_Heavy_C::ReceiveIsFinished()
{
	static UFunction* fn;
	...
	UCS_Land_Heavy_C_ReceiveIsFinished_Params params;
...
void UCS_Land_Heavy_C::BlueprintUpdateCameraShake(float DeltaTime, float ALPHA, const struct FMinimalViewInfo& POV, struct FMinimalViewInfo* ModifiedPOV)
{
	static UFunction* fn;
	...
	UCS_Land_Heavy_C_BlueprintUpdateCameraShake_Params params;
