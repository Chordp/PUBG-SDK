...
#include "PUBG_BP_Console_Icon_Y_structs.hpp"
...
// WidgetBlueprintGeneratedClass BP_Console_Icon_Y.BP_Console_Icon_Y_C
// 0x0031 (0x0279 - 0x0248)
class UBP_Console_Icon_Y_C : public UUserWidget
{
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr;
		if(!ptr)
			ptr = UObject::FindClass(_xor_("WidgetBlueprintGeneratedClass BP_Console_Icon_Y.BP_Console_Icon_Y_C"));
	...
	void Construct();
	void ExecuteUbergraph_BP_Console_Icon_Y(int* EntryPoint);
};
