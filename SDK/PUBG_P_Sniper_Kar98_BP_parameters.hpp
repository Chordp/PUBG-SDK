...
struct AP_Sniper_Kar98_BP_C_GetWaterVolumeHeight_Params
{
...
struct AP_Sniper_Kar98_BP_C_GetPhysicalSurfaceFromRay_Params
{
...
struct AP_Sniper_Kar98_BP_C_GetParticleVectorParamter_Params
{
	struct FName                                       Name;                                                     // (ConstParm, Parm, ZeroConstructor, IsPlainOldData)
...
struct AP_Sniper_Kar98_BP_C_GetParticleParamterByName_Params
{
	struct FName                                       Name;                                                     // (ConstParm, Parm, ZeroConstructor, IsPlainOldData)
