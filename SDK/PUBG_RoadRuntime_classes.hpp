...
{
public:
	struct FString                                     UniqueKey;                                                // 0x0420(0x0010) (ZeroConstructor)
	TArray<struct FCrossActorManager>                  SideActors;                                               // 0x0430(0x0010) (ZeroConstructor)
	TArray<struct FCrossMeshManager>                   SideMeshes;                                               // 0x0440(0x0010) (ZeroConstructor)
...
{
public:
	TEnumAsByte<ESplineMeshAxis>                       SplineMeshAxis;                                           // 0x0410(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0411(0x0003) MISSED OFFSET
	struct FVector                                     LocalOffset;                                              // 0x0414(0x000C) (IsPlainOldData)
	class ARoadActor*                                  Father;                                                   // 0x0420(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	struct FString                                     UniqueKey;                                                // 0x0428(0x0010) (ZeroConstructor)
	class USplineComponent*                            Spline;                                                   // 0x0438(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
	int                                                Index;                                                    // 0x0440(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                Segmentation;                                             // 0x0444(0x0004) (ZeroConstructor, IsPlainOldData)
	int                                                StepGeneration;                                           // 0x0448(0x0004) (ZeroConstructor, IsPlainOldData)
	float                                              Size;                                                     // 0x044C(0x0004) (ZeroConstructor, IsPlainOldData)
	class UStaticMesh*                                 RoadMesh;                                                 // 0x0450(0x0008) (ZeroConstructor, IsPlainOldData)
	TArray<class USplineMeshComponent*>                RoadMeshesComp;                                           // 0x0458(0x0010) (ExportObject, ZeroConstructor)
	TArray<struct FSideActorManager>                   SideActors;                                               // 0x0468(0x0010) (ZeroConstructor)
	TArray<struct FSideMeshManager>                    SideMeshes;                                               // 0x0478(0x0010) (ZeroConstructor)
	TArray<struct FCurbsManager>                       SideCurbs;                                                // 0x0488(0x0010) (ZeroConstructor)
