...
#include "PUBG_P_Footprint_Sand_BP_structs.hpp"
...
// BlueprintGeneratedClass P_Footprint_Sand_BP.P_Footprint_Sand_BP_C
// 0x0000 (0x04C0 - 0x04C0)
class AP_Footprint_Sand_BP_C : public ATslParticle
{
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr;
		if(!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass P_Footprint_Sand_BP.P_Footprint_Sand_BP_C"));
