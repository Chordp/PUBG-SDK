...
#include "PUBG_BP_Console_Icon_X_structs.hpp"
...
// WidgetBlueprintGeneratedClass BP_Console_Icon_X.BP_Console_Icon_X_C
// 0x0031 (0x0279 - 0x0248)
class UBP_Console_Icon_X_C : public UUserWidget
{
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr;
		if(!ptr)
			ptr = UObject::FindClass(_xor_("WidgetBlueprintGeneratedClass BP_Console_Icon_X.BP_Console_Icon_X_C"));
	...
	void Construct();
	void ExecuteUbergraph_BP_Console_Icon_X(int* EntryPoint);
};
