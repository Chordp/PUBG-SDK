...
#include "PUBG_P_Footprint_Ice_BP_parameters.hpp"
...
void AP_Footprint_Ice_BP_C::SetParticleParameter(const struct FName& Name, const struct FVector& Value, bool bEnableRTPC)
{
	static UFunction* fn;
	...
	AP_Footprint_Ice_BP_C_SetParticleParameter_Params params;
	params.Name = Name;
	params.Value = Value;
...
void AP_Footprint_Ice_BP_C::OnParticleFinish(class UParticleSystemComponent* PSystem)
{
	static UFunction* fn;
	...
	AP_Footprint_Ice_BP_C_OnParticleFinish_Params params;
...
void AP_Footprint_Ice_BP_C::OnParticleCollide(const struct FName& EventName, float EmitterTime, int ParticleTime, const struct FVector& Location, const struct FVector& Velocity, const struct FVector& Direction, const struct FVector& Normal, const struct FName& BoneName, class UPhysicalMaterial* PhysMat)
{
	static UFunction* fn;
	...
	AP_Footprint_Ice_BP_C_OnParticleCollide_Params params;
...
void AP_Footprint_Ice_BP_C::OnParameterUpdated()
{
	static UFunction* fn;
	...
	AP_Footprint_Ice_BP_C_OnParameterUpdated_Params params;
...
void AP_Footprint_Ice_BP_C::GetWaterVolumeHeight(bool* OutbIsInWater, float* OutWaterHeight)
{
	static UFunction* fn;
	...
	AP_Footprint_Ice_BP_C_GetWaterVolumeHeight_Params params;
...
TEnumAsByte<EPhysicalSurface> AP_Footprint_Ice_BP_C::GetPhysicalSurfaceFromRay(const struct FVector& StartActorOffset, const struct FVector& TraceRay)
{
	static UFunction* fn;
	...
	AP_Footprint_Ice_BP_C_GetPhysicalSurfaceFromRay_Params params;
...
struct FVector AP_Footprint_Ice_BP_C::GetParticleVectorParamter(const struct FName& Name, const struct FVector& DefaultValue)
{
	static UFunction* fn;
	...
	AP_Footprint_Ice_BP_C_GetParticleVectorParamter_Params params;
	params.Name = Name;
...
float AP_Footprint_Ice_BP_C::GetParticleParamterByName(const struct FName& Name, float DefaultValue)
{
	static UFunction* fn;
	...
	AP_Footprint_Ice_BP_C_GetParticleParamterByName_Params params;
	params.Name = Name;
	params.DefaultValue = DefaultValue;
...
float AP_Footprint_Ice_BP_C::GetParticleParamter(const struct FString& Name, float DefaultValue)
{
	static UFunction* fn;
	...
	AP_Footprint_Ice_BP_C_GetParticleParamter_Params params;
	params.Name = Name;
	params.DefaultValue = DefaultValue;
...
float AP_Footprint_Ice_BP_C::STATIC_GetEmitterGlobalSpawnRateScale()
{
	static UFunction* fn;
	...
	AP_Footprint_Ice_BP_C_GetEmitterGlobalSpawnRateScale_Params params;
...
void AP_Footprint_Ice_BP_C::ForceSpawn(int EmitterIndex, const struct FVector& InLocation)
{
	static UFunction* fn;
	...
	AP_Footprint_Ice_BP_C_ForceSpawn_Params params;
...
void AP_Footprint_Ice_BP_C::AttachToParent()
{
	static UFunction* fn;
	...
	AP_Footprint_Ice_BP_C_AttachToParent_Params params;
