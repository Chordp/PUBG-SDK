...
#include "PUBG_JerryCan_Explosion_parameters.hpp"
...
void AJerryCan_Explosion_C::OnParticleCollide(const struct FName& EventName, float EmitterTime, int ParticleTime, const struct FVector& Location, const struct FVector& Velocity, const struct FVector& Direction, const struct FVector& Normal, const struct FName& BoneName)
{
	static UFunction* fn;
	...
	AJerryCan_Explosion_C_OnParticleCollide_Params params;
