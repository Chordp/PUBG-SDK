...
#include "PUBG_CS_WeapGun_Sniper_762_Kar98_Scope_classes.hpp"
...
struct UCS_WeapGun_Sniper_762_Kar98_Scope_C_ReceiveStopShake_Params
{
	bool                                               bImmediately;                                             // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.CameraShake.ReceivePlayShake
struct UCS_WeapGun_Sniper_762_Kar98_Scope_C_ReceivePlayShake_Params
{
	float                                              Scale;                                                    // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function Engine.CameraShake.ReceiveIsFinished
struct UCS_WeapGun_Sniper_762_Kar98_Scope_C_ReceiveIsFinished_Params
{
	bool                                               ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function Engine.CameraShake.BlueprintUpdateCameraShake
struct UCS_WeapGun_Sniper_762_Kar98_Scope_C_BlueprintUpdateCameraShake_Params
{
