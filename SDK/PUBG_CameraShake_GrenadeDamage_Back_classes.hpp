...
#include "PUBG_CameraShake_GrenadeDamage_Back_structs.hpp"
...
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr;
		if(!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass CameraShake_GrenadeDamage_Back.CameraShake_GrenadeDamage_Back_C"));
