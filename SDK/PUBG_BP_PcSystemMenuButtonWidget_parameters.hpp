...
#include "PUBG_BP_PcSystemMenuButtonWidget_classes.hpp"
...
struct UBP_PcSystemMenuButtonWidget_C_PreConstruct_Params
{
...
struct UBP_PcSystemMenuButtonWidget_C_BndEvt__Button_Internal_K2Node_ComponentBoundEvent_0_OnButtonClickedEvent__DelegateSignature_Params
{
};

// Function BP_PcSystemMenuButtonWidget.BP_PcSystemMenuButtonWidget_C.ExecuteUbergraph_BP_PcSystemMenuButtonWidget
struct UBP_PcSystemMenuButtonWidget_C_ExecuteUbergraph_BP_PcSystemMenuButtonWidget_Params
{
	int*                                               EntryPoint;                                               // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function BP_PcSystemMenuButtonWidget.BP_PcSystemMenuButtonWidget_C.OnClicked__DelegateSignature
struct UBP_PcSystemMenuButtonWidget_C_OnClicked__DelegateSignature_Params
{
};
