...
struct UMainLobbyHUD_C_HasChildren_Params
{
	bool                                               ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function MainLobbyHUD.MainLobbyHUD_C.ToggleSystemMenu
struct UMainLobbyHUD_C_ToggleSystemMenu_Params
{
};
...
struct UMainLobbyHUD_C_HideCurtain_Params
{
};

// Function MainLobbyHUD.MainLobbyHUD_C.ShowCurtain
struct UMainLobbyHUD_C_ShowCurtain_Params
{
};
...
struct UMainLobbyHUD_C_InitializeMainUMGHUD_Params
{
};
