...
struct FBasedMovementInfo
{
	...
	struct FVector                                     MovingBaseRelativeVelocity;                               // 0x0038(0x000C) (IsPlainOldData)
...
struct FMinimalViewInfo
{
	...
	float                                              FOV;                                                      // 0x0004(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              OrthoNearClipPlane;                                       // 0x0008(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	TEnumAsByte<ECameraProjectionMode>                 ProjectionMode;                                           // 0x000C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x000D(0x0003) MISSED OFFSET
	unsigned char                                      bConstrainAspectRatio : 1;                                // 0x0010(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bUseFieldOfViewForLOD : 1;                                // 0x0010(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0011(0x0003) MISSED OFFSET
	float                                              OrthoFarClipPlane;                                        // 0x0014(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector                                     Location;                                                 // 0x0018(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	float                                              AspectRatio;                                              // 0x0024(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	struct FRotator                                    Rotation;                                                 // 0x05A8(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	float                                              OrthoWidth;                                               // 0x05B4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
	struct FStringAssetReference                       Template;                                                 // 0x0000(0x0010) (Edit)
...
struct FSplineInstanceData
{
	...
	struct FVector                                     SplineUpDir;                                              // 0x0058(0x000C) (Edit, IsPlainOldData)
};
...
{
	struct FMatrix                                     Transform;                                                // 0x0000(0x0040) (Edit, IsPlainOldData)
	struct FVector4                                    PerInstanceCustomData;                                    // 0x0040(0x0010) (Edit, IsPlainOldData)
};
...
{
	struct FGuid                                       LandscapeGuid;                                            // 0x0000(0x0010) (IsPlainOldData)
	struct FIntPoint                                   ComponentId;                                              // 0x0010(0x0008) (IsPlainOldData)
};
...
struct FLevelBlockLandscapeData
{
	...
	struct FIntPoint                                   Size;                                                     // 0x0040(0x0008) (IsPlainOldData)
	struct FIntPoint                                   BlendMaskSize;                                            // 0x0048(0x0008) (IsPlainOldData)
...
{
	struct FVector                                     DecalSize;                                                // 0x0000(0x000C) (IsPlainOldData)
	unsigned char                                      UnknownData00[0x4];                                       // 0x000C(0x0004) MISSED OFFSET
	...
	bool                                               bIsGraffitiDecal;                                         // 0x001C(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x001D(0x0003) MISSED OFFSET
};
...
struct FMinimapLabelInstance
{
	...
	struct FVector2D                                   Offset;                                                   // 0x0010(0x0008) (IsPlainOldData)
...
struct FPointLightVariant
{
	...
	TAssetPtr<class UMaterialInterface>                LightFunctionMaterial;                                    // 0x0008(0x0020)
	TAssetPtr<class UTextureLightProfile>              IESTexture;                                               // 0x0028(0x0020)
	...
	struct FVector                                     LightFunctionScale;                                       // 0x0068(0x000C) (IsPlainOldData)
	...
	struct FColor                                      BloomTint;                                                // 0x0088(0x0004) (IsPlainOldData)
...
{
	TAssetPtr<class UStaticMesh>                       Mesh;                                                     // 0x0000(0x0020)
	TArray<TAssetPtr<class UMaterialInterface>>        MaterialOverrides;                                        // 0x0020(0x0010) (ZeroConstructor)
...
struct FStaticMeshInstance
{
	...
	struct FLinearColor                                PerInstanceCustomData;                                    // 0x0038(0x0010) (IsPlainOldData)
...
struct FWorldContext
{
	...
	TArray<struct FFullyLoadedPackagesInfo>            PackagesToFullyLoad;                                      // 0x0038(0x0010) (ZeroConstructor)
	TArray<struct FNamedNetDriver>                     ActiveNetDrivers;                                         // 0x0048(0x0010) (ZeroConstructor, Transient)
	class UPendingNetGame*                             PendingNetGame;                                           // 0x0058(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FURL                                        LastURL;                                                  // 0x0060(0x0070)
	unsigned char                                      UnknownData01[0x18];                                      // 0x00D0(0x0018) MISSED OFFSET
	unsigned char                                      UnknownData02[0x8];                                       // 0x00D0(0x0008) UNKNOWN PROPERTY: EncryptedObjectProperty Engine.WorldContext.GameViewport
	struct FURL                                        LastRemoteURL;                                            // 0x00F0(0x0070)
	unsigned char                                      UnknownData03[0x10];                                      // 0x0160(0x0010) MISSED OFFSET
	unsigned char                                      UnknownData04[0x8];                                       // 0x0160(0x0008) UNKNOWN PROPERTY: EncryptedObjectProperty Engine.WorldContext.OwningGameInstance
	unsigned char                                      UnknownData05[0x8];                                       // 0x0178(0x0008) MISSED OFFSET
	TArray<class ULevel*>                              LoadedLevelsForPendingMapChange;                          // 0x0180(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData06[0x28];                                      // 0x0190(0x0028) MISSED OFFSET
	TArray<class UObjectReferencer*>                   ObjectReferencers;                                        // 0x01B8(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData07[0xE0];                                      // 0x01C8(0x00E0) MISSED OFFSET
};
...
{
	struct FVector4                                    InstanceOrigin;                                           // 0x0000(0x0010) (IsPlainOldData)
	struct FVector4                                    InstanceTransform1;                                       // 0x0010(0x0010) (IsPlainOldData)
	struct FVector4                                    InstanceTransform2;                                       // 0x0020(0x0010) (IsPlainOldData)
	struct FVector4                                    InstanceTransform3;                                       // 0x0030(0x0010) (IsPlainOldData)
};
