...
{
	float                                              OrthoFarClipPlane;                                        // 0x0000(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	float                                              PostProcessBlendWeight;                                   // 0x0014(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector2D                                   OffCenterProjectionOffset;                                // 0x0018(0x0008) (Edit, BlueprintVisible, DisableEditOnTemplate, Transient, EditConst, IsPlainOldData)
	...
	struct FRotator                                    Rotation;                                                 // 0x05A0(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	float                                              OrthoWidth;                                               // 0x05AC(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector                                     Location;                                                 // 0x05B0(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
...
struct FWorldContext
{
	...
	unsigned char                                      UnknownData00[0x8];                                       // 0x0010(0x0008) MISSED OFFSET
	unsigned char                                      UnknownData01[0x8];                                       // 0x0010(0x0008) UNKNOWN PROPERTY: EncryptedObjectProperty Engine.WorldContext.OwningGameInstance
	struct FURL                                        LastURL;                                                  // 0x0020(0x0070)
	TArray<struct FFullyLoadedPackagesInfo>            PackagesToFullyLoad;                                      // 0x0090(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData02[0x20];                                      // 0x00A0(0x0020) MISSED OFFSET
	class UPendingNetGame*                             PendingNetGame;                                           // 0x00C0(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData03[0x20];                                      // 0x00C8(0x0020) MISSED OFFSET
	TArray<class UObjectReferencer*>                   ObjectReferencers;                                        // 0x00E8(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData04[0x10];                                      // 0x00F8(0x0010) MISSED OFFSET
	struct FURL                                        LastRemoteURL;                                            // 0x0108(0x0070)
	TArray<class ULevel*>                              LoadedLevelsForPendingMapChange;                          // 0x0178(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData05[0xE0];                                      // 0x0188(0x00E0) MISSED OFFSET
	unsigned char                                      UnknownData06[0x8];                                       // 0x0188(0x0008) UNKNOWN PROPERTY: EncryptedObjectProperty Engine.WorldContext.GameViewport
	unsigned char                                      UnknownData07[0x18];                                      // 0x0270(0x0018) MISSED OFFSET
	TArray<struct FLevelStreamingStatus>               PendingLevelStreamingStatusUpdates;                       // 0x0288(0x0010) (ZeroConstructor)
