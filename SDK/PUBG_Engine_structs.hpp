...
struct FMinimalViewInfo
{
	...
	unsigned char                                      bConstrainAspectRatio : 1;                                // 0x0008(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      bUseFieldOfViewForLOD : 1;                                // 0x0008(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0009(0x0003) MISSED OFFSET
	float                                              OrthoFarClipPlane;                                        // 0x000C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FRotator                                    Rotation;                                                 // 0x0010(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	float                                              OrthoNearClipPlane;                                       // 0x001C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FPostProcessSettings                        PostProcessSettings;                                      // 0x0020(0x0570) (BlueprintVisible)
	TEnumAsByte<ECameraProjectionMode>                 ProjectionMode;                                           // 0x0590(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x3];                                       // 0x0591(0x0003) MISSED OFFSET
	struct FVector                                     Location;                                                 // 0x0594(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	float                                              AspectRatio;                                              // 0x05A0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              PostProcessBlendWeight;                                   // 0x05A4(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector2D                                   OffCenterProjectionOffset;                                // 0x05A8(0x0008) (Edit, BlueprintVisible, DisableEditOnTemplate, Transient, EditConst, IsPlainOldData)
};
...
struct FWorldContext
{
	...
	TArray<class UObjectReferencer*>                   ObjectReferencers;                                        // 0x0040(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData01[0x10];                                      // 0x0050(0x0010) MISSED OFFSET
	class UPendingNetGame*                             PendingNetGame;                                           // 0x0060(0x0008) (ZeroConstructor, IsPlainOldData)
	struct FURL                                        LastURL;                                                  // 0x0068(0x0070)
	unsigned char                                      UnknownData02[0xC8];                                      // 0x00D8(0x00C8) MISSED OFFSET
	unsigned char                                      UnknownData03[0x8];                                       // 0x00D8(0x0008) UNKNOWN PROPERTY: EncryptedObjectProperty Engine.WorldContext.OwningGameInstance
	unsigned char                                      UnknownData04[0x8];                                       // 0x01A8(0x0008) MISSED OFFSET
	TArray<class ULevel*>                              LoadedLevelsForPendingMapChange;                          // 0x01B0(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData05[0x10];                                      // 0x01C0(0x0010) MISSED OFFSET
	TArray<struct FFullyLoadedPackagesInfo>            PackagesToFullyLoad;                                      // 0x01D0(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData06[0x8];                                       // 0x01E0(0x0008) MISSED OFFSET
	TArray<struct FNamedNetDriver>                     ActiveNetDrivers;                                         // 0x01E8(0x0010) (ZeroConstructor, Transient)
	struct FURL                                        LastRemoteURL;                                            // 0x01F8(0x0070)
	unsigned char                                      UnknownData07[0x20];                                      // 0x0268(0x0020) MISSED OFFSET
	unsigned char                                      UnknownData08[0x8];                                       // 0x0268(0x0008) UNKNOWN PROPERTY: EncryptedObjectProperty Engine.WorldContext.GameViewport
	unsigned char                                      UnknownData09[0x8];                                       // 0x0290(0x0008) MISSED OFFSET
};
