...
struct FMinimalViewInfo
{
	...
	unsigned char                                      bUseFieldOfViewForLOD : 1;                                // 0x0000(0x0001) (Edit, BlueprintVisible)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0001(0x0003) MISSED OFFSET
	float                                              OrthoNearClipPlane;                                       // 0x0004(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FRotator                                    Rotation;                                                 // 0x0008(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	float                                              AspectRatio;                                              // 0x0014(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              FOV;                                                      // 0x0018(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x4];                                       // 0x001C(0x0004) MISSED OFFSET
	struct FPostProcessSettings                        PostProcessSettings;                                      // 0x0020(0x0570) (BlueprintVisible)
	float                                              OrthoFarClipPlane;                                        // 0x0590(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              PostProcessBlendWeight;                                   // 0x0594(0x0004) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              OrthoWidth;                                               // 0x0598(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FVector                                     Location;                                                 // 0x059C(0x000C) (Edit, BlueprintVisible, IsPlainOldData)
	TEnumAsByte<ECameraProjectionMode>                 ProjectionMode;                                           // 0x05A8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x3];                                       // 0x05A9(0x0003) MISSED OFFSET
	struct FVector2D                                   OffCenterProjectionOffset;                                // 0x05AC(0x0008) (Edit, BlueprintVisible, DisableEditOnTemplate, Transient, EditConst, IsPlainOldData)
...
struct FWorldContext
{
	...
	unsigned char                                      UnknownData00[0x8];                                       // 0x0010(0x0008) MISSED OFFSET
	class UPendingNetGame*                             PendingNetGame;                                           // 0x0018(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0xD8];                                      // 0x0020(0x00D8) MISSED OFFSET
	struct FURL                                        LastRemoteURL;                                            // 0x00F8(0x0070)
	unsigned char                                      UnknownData02[0x10];                                      // 0x0168(0x0010) MISSED OFFSET
	TArray<class UObjectReferencer*>                   ObjectReferencers;                                        // 0x0178(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData03[0x8];                                       // 0x0188(0x0008) MISSED OFFSET
	unsigned char                                      UnknownData04[0x8];                                       // 0x0188(0x0008) UNKNOWN PROPERTY: EncryptedObjectProperty Engine.WorldContext.OwningGameInstance
	TArray<class ULevel*>                              LoadedLevelsForPendingMapChange;                          // 0x0198(0x0010) (ZeroConstructor)
	struct FURL                                        LastURL;                                                  // 0x01A8(0x0070)
	unsigned char                                      UnknownData05[0x20];                                      // 0x0218(0x0020) MISSED OFFSET
	unsigned char                                      UnknownData06[0x8];                                       // 0x0218(0x0008) UNKNOWN PROPERTY: EncryptedObjectProperty Engine.WorldContext.GameViewport
	unsigned char                                      UnknownData07[0x18];                                      // 0x0240(0x0018) MISSED OFFSET
	TArray<struct FFullyLoadedPackagesInfo>            PackagesToFullyLoad;                                      // 0x0258(0x0010) (ZeroConstructor)
	TArray<struct FLevelStreamingStatus>               PendingLevelStreamingStatusUpdates;                       // 0x0268(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData08[0x28];                                      // 0x0278(0x0028) MISSED OFFSET
};
