...
#include "PUBG_P_Carepackage_Smoke_classes.hpp"
...
struct AP_Carepackage_Smoke_C_SetParticleParameter_Params
{
...
struct AP_Carepackage_Smoke_C_OnParticleFinish_Params
{
...
struct AP_Carepackage_Smoke_C_OnParticleCollide_Params
{
...
struct AP_Carepackage_Smoke_C_OnParameterUpdated_Params
{
};

// Function TslGame.TslParticle.GetWaterVolumeHeight
struct AP_Carepackage_Smoke_C_GetWaterVolumeHeight_Params
{
...
struct AP_Carepackage_Smoke_C_GetPhysicalSurfaceFromRay_Params
{
...
struct AP_Carepackage_Smoke_C_GetParticleVectorParamter_Params
{
	struct FName                                       Name;                                                     // (ConstParm, Parm, ZeroConstructor, IsPlainOldData)
...
struct AP_Carepackage_Smoke_C_GetParticleParamterByName_Params
{
	struct FName                                       Name;                                                     // (ConstParm, Parm, ZeroConstructor, IsPlainOldData)
...
struct AP_Carepackage_Smoke_C_GetParticleParamter_Params
{
...
struct AP_Carepackage_Smoke_C_GetEmitterGlobalSpawnRateScale_Params
{
	float                                              ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function TslGame.TslParticle.ForceSpawn
struct AP_Carepackage_Smoke_C_ForceSpawn_Params
{
...
struct AP_Carepackage_Smoke_C_AttachToParent_Params
{
};
