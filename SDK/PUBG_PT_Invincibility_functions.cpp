...
#include "PUBG_PT_Invincibility_parameters.hpp"
...
void APT_Invincibility_C::StopParticleMulticast()
{
	static UFunction* fn;
	...
	APT_Invincibility_C_StopParticleMulticast_Params params;
...
void APT_Invincibility_C::OnParticleFinish(class UParticleSystemComponent* PSystem)
{
	static UFunction* fn;
	...
	APT_Invincibility_C_OnParticleFinish_Params params;
