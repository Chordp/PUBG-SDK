...
#include "PUBG_CS_WeapGun_Rifle_parameters.hpp"
...
void UCS_WeapGun_Rifle_762_C::STATIC_ReceiveStopShake(bool bImmediately)
{
	static UFunction* fn;
	...
	UCS_WeapGun_Rifle_762_C_ReceiveStopShake_Params params;
...
void UCS_WeapGun_Rifle_762_C::STATIC_ReceivePlayShake(float Scale)
{
	static UFunction* fn;
	...
	UCS_WeapGun_Rifle_762_C_ReceivePlayShake_Params params;
	params.Scale = Scale;
...
bool UCS_WeapGun_Rifle_762_C::STATIC_ReceiveIsFinished()
{
	static UFunction* fn;
	...
	UCS_WeapGun_Rifle_762_C_ReceiveIsFinished_Params params;
...
void UCS_WeapGun_Rifle_762_C::STATIC_BlueprintUpdateCameraShake(float DeltaTime, float ALPHA, const struct FMinimalViewInfo& POV, struct FMinimalViewInfo* ModifiedPOV)
{
	static UFunction* fn;
	...
	UCS_WeapGun_Rifle_762_C_BlueprintUpdateCameraShake_Params params;
