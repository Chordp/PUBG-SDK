...
#include "PUBG_CameraShake_GrenadeDamage_Back_TPP_parameters.hpp"
...
void UCameraShake_GrenadeDamage_Back_TPP_C::ReceiveStopShake(bool bImmediately)
{
	static UFunction* fn;
	...
	UCameraShake_GrenadeDamage_Back_TPP_C_ReceiveStopShake_Params params;
...
void UCameraShake_GrenadeDamage_Back_TPP_C::ReceivePlayShake(float Scale)
{
	static UFunction* fn;
	...
	UCameraShake_GrenadeDamage_Back_TPP_C_ReceivePlayShake_Params params;
	params.Scale = Scale;
...
bool UCameraShake_GrenadeDamage_Back_TPP_C::ReceiveIsFinished()
{
	static UFunction* fn;
	...
	UCameraShake_GrenadeDamage_Back_TPP_C_ReceiveIsFinished_Params params;
...
void UCameraShake_GrenadeDamage_Back_TPP_C::BlueprintUpdateCameraShake(float DeltaTime, float ALPHA, const struct FMinimalViewInfo& POV, struct FMinimalViewInfo* ModifiedPOV)
{
	static UFunction* fn;
	...
	UCameraShake_GrenadeDamage_Back_TPP_C_BlueprintUpdateCameraShake_Params params;
