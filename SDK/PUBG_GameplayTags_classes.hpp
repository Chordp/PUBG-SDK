...
public:
	...
	TArray<class UDataTable*>                          GameplayTagTables;                                        // 0x0128(0x0010) (ZeroConstructor)
...
public:
	...
	TArray<struct FGameplayTagCategoryRemap>           CategoryRemapping;                                        // 0x0058(0x0010) (Edit, ZeroConstructor, Config)
	bool                                               FastReplication;                                          // 0x0068(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x7];                                       // 0x0069(0x0007) MISSED OFFSET
	TArray<struct FStringAssetReference>               GameplayTagTableList;                                     // 0x0070(0x0010) (Edit, ZeroConstructor, Config)
