...
#include "PUBG_P_Underwater_Bubbles_BP_classes.hpp"
...
struct AP_Underwater_Bubbles_BP_C_SetParticleParameter_Params
{
...
struct AP_Underwater_Bubbles_BP_C_OnParticleFinish_Params
{
...
struct AP_Underwater_Bubbles_BP_C_OnParticleCollide_Params
{
...
struct AP_Underwater_Bubbles_BP_C_OnParameterUpdated_Params
{
};

// Function TslGame.TslParticle.GetWaterVolumeHeight
struct AP_Underwater_Bubbles_BP_C_GetWaterVolumeHeight_Params
{
...
struct AP_Underwater_Bubbles_BP_C_GetPhysicalSurfaceFromRay_Params
{
...
struct AP_Underwater_Bubbles_BP_C_GetParticleVectorParamter_Params
{
	struct FName                                       Name;                                                     // (ConstParm, Parm, ZeroConstructor, IsPlainOldData)
...
struct AP_Underwater_Bubbles_BP_C_GetParticleParamterByName_Params
{
	struct FName                                       Name;                                                     // (ConstParm, Parm, ZeroConstructor, IsPlainOldData)
...
struct AP_Underwater_Bubbles_BP_C_GetParticleParamter_Params
{
...
struct AP_Underwater_Bubbles_BP_C_GetEmitterGlobalSpawnRateScale_Params
{
	float                                              ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function TslGame.TslParticle.ForceSpawn
struct AP_Underwater_Bubbles_BP_C_ForceSpawn_Params
{
...
struct AP_Underwater_Bubbles_BP_C_AttachToParent_Params
{
};
