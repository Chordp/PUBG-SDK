...
#include "PUBG_BP_ShellEvent_Smg_parameters.hpp"
...
void UBP_ShellEvent_SMG_C::RunEvent(const struct FVector& InCollideDirection, const struct FVector& InHitLocation, const struct FVector& InHitNormal, const struct FName& InBoneName, class UWorld* InWorld, class AActor* InActor)
{
	static UFunction* fn;

		if(!fn)
		fn = UObject::FindObject<UFunction>(_xor_("Function BP_ShellEvent_Smg.BP_ShellEvent_SMG_C.RunEvent"));

	UBP_ShellEvent_SMG_C_RunEvent_Params params;
...
void UBP_ShellEvent_SMG_C::ExecuteUbergraph_BP_ShellEvent_SMG(int EntryPoint)
{
	static UFunction* fn;

		if(!fn)
		fn = UObject::FindObject<UFunction>(_xor_("Function BP_ShellEvent_Smg.BP_ShellEvent_SMG_C.ExecuteUbergraph_BP_ShellEvent_SMG"));

	UBP_ShellEvent_SMG_C_ExecuteUbergraph_BP_ShellEvent_SMG_Params params;
