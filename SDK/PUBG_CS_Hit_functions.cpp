...
#include "PUBG_CS_Hit_parameters.hpp"
...
void UCS_Hit_C::ReceiveStopShake(bool bImmediately)
{
	static UFunction* fn;
	...
	UCS_Hit_C_ReceiveStopShake_Params params;
...
void UCS_Hit_C::ReceivePlayShake(float Scale)
{
	static UFunction* fn;
	...
	UCS_Hit_C_ReceivePlayShake_Params params;
	params.Scale = Scale;
...
bool UCS_Hit_C::ReceiveIsFinished()
{
	static UFunction* fn;
	...
	UCS_Hit_C_ReceiveIsFinished_Params params;
...
void UCS_Hit_C::BlueprintUpdateCameraShake(float DeltaTime, float ALPHA, const struct FMinimalViewInfo& POV, struct FMinimalViewInfo* ModifiedPOV)
{
	static UFunction* fn;
	...
	UCS_Hit_C_BlueprintUpdateCameraShake_Params params;
