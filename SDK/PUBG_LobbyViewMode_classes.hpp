...
public:
	...
	struct FRotator                                    Target;                                                   // 0x0450(0x000C) (Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData)
	struct FRotator                                    Rollback;                                                 // 0x045C(0x000C) (Edit, BlueprintVisible, DisableEditOnInstance, IsPlainOldData)
