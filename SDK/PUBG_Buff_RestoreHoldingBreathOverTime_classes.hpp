...
public:
	...
	float                                              DelayAfterHolding;                                        // 0x04B8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	struct FTimerHandle                                DelayAfterHoldingTimerHandle;                             // 0x04C8(0x0008) (Edit, BlueprintVisible, DisableEditOnInstance)
