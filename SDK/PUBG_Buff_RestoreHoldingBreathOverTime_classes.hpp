...
public:
	...
	float                                              DelayAfterHolding;                                        // 0x0488(0x0004) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	struct FTimerHandle                                DelayAfterHoldingTimerHandle;                             // 0x0498(0x0008) (Edit, BlueprintVisible, DisableEditOnInstance)
