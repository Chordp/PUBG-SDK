...
public:
	...
	class USceneComponent*                             PlayerCardScene;                                          // 0x0408(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class USceneComponent*                             LobbyScene;                                               // 0x0410(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	TArray<struct FPoseCharacterAttachments>           CharacterAttachedObjects;                                 // 0x0428(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
