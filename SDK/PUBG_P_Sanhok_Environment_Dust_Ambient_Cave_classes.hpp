...
#include "PUBG_P_Sanhok_Environment_Dust_Ambient_Cave_structs.hpp"
...
// BlueprintGeneratedClass P_Sanhok_Environment_Dust_Ambient_Cave.P_Sanhok_Environment_Dust_Ambient_Cave_C
// 0x0054 (0x0524 - 0x04D0)
class AP_Sanhok_Environment_Dust_Ambient_Cave_C : public ATslParticleEnvironment
{
public:
	...
	float                                              LifetimeMin;                                              // 0x051C(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              LifetimeMax;                                              // 0x0520(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)

	static UClass* StaticClass()
	{
		static UClass* ptr;
		if(!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass P_Sanhok_Environment_Dust_Ambient_Cave.P_Sanhok_Environment_Dust_Ambient_Cave_C"));
