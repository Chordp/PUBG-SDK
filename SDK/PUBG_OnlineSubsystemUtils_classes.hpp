...
{
public:
	unsigned char                                      LogPortUnreach : 1;                                       // 0x04B0(0x0001) (Config)
	unsigned char                                      AllowPlayerPortUnreach : 1;                               // 0x04B0(0x0001) (Config)
	unsigned char                                      UnknownData00[0x3];                                       // 0x04B1(0x0003) MISSED OFFSET
	uint32_t                                           MaxPortCountToTry;                                        // 0x04B4(0x0004) (ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData01[0x18];                                      // 0x04B8(0x0018) MISSED OFFSET
	uint32_t                                           ServerDesiredSocketReceiveBufferBytes;                    // 0x04D0(0x0004) (ZeroConstructor, Config, IsPlainOldData)
...
public:
	...
	struct FString                                     DestSessionId;                                            // 0x0550(0x0010) (ZeroConstructor)
