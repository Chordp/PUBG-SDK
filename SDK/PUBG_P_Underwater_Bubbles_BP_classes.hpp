...
#include "PUBG_P_Underwater_Bubbles_BP_structs.hpp"
...
class AP_Underwater_Bubbles_BP_C : public ATslParticle
{
public:
	...
	static UClass* StaticClass()
	{
		static UClass* ptr;
		if(!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass P_Underwater_Bubbles_BP.P_Underwater_Bubbles_BP_C"));
