...
#include "PUBG_BP_MasteryPose_Flare_structs.hpp"
...
class ABP_MasteryPose_Flare_C : public ABP_MasteryPose_C
{
public:
	...
	class UParticleSystemComponent*                    ParticleSystemPlayerCard;                                 // 0x0450(0x0008) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	static UClass* StaticClass()
	{
		static UClass* ptr;
		if(!ptr)
			ptr = UObject::FindClass(_xor_("BlueprintGeneratedClass BP_MasteryPose_Flare.BP_MasteryPose_Flare_C"));
	...
	void ExecuteUbergraph_BP_MasteryPose_Flare(int* EntryPoint);
};
