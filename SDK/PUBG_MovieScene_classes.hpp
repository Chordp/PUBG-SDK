...
{
public:
	struct FGuid                                       Signature;                                                // 0x0040(0x0010) (IsPlainOldData)
...
public:
	...
	unsigned char                                      UnknownData03[0x300];                                     // 0x0410(0x0300) MISSED OFFSET
...
public:
	...
	TArray<struct FMovieSceneBindingOverrideData>      BindingData;                                              // 0x0048(0x0010) (Edit, ZeroConstructor)
...
{
public:
	struct FName                                       FolderName;                                               // 0x0040(0x0008) (ZeroConstructor, IsPlainOldData)
	TArray<class UMovieSceneFolder*>                   ChildFolders;                                             // 0x0048(0x0010) (ZeroConstructor)
	TArray<class UMovieSceneTrack*>                    ChildMasterTracks;                                        // 0x0058(0x0010) (ExportObject, ZeroConstructor)
	TArray<struct FString>                             ChildObjectBindingStrings;                                // 0x0068(0x0010) (ZeroConstructor)
